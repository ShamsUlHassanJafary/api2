...
public class Api2Application {
	 ...
	 * 
	 * return new ApiInfo( "SandBox Api1",
	 * "SandBox Api1 for retriving data from SandBox Api1", "1.0", "Free to Use",
	 * new springfox.documentation.service.Contact("Mr Mao",
	 * "http://www.carconnect.uk/", "mao@gmail.com"), "API Licence",
	 * "http://www.carconnect.uk/", Collections.emptyList()); }
	 */
