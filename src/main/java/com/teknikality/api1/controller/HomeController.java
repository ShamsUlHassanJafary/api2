...
public class HomeController {
	...
	public ResponseEntity<Vehicle> updateVehicleFromAPI(@PathVariable("registrationNumber") String registrationNumber, Vehicle vehicle)
...
//			vehicleRepo.save(vehicle);
	...
	public ResponseEntity<Vehicle> getVehicleDataFromdb(@PathVariable("registrationNumber") String registrationNumber)
			throws IOException, InterruptedException {
	...
	public ResponseEntity<String> deleteVehicle(@PathVariable("registrationNumber") String registrationNumber)
			throws IOException, InterruptedException {
